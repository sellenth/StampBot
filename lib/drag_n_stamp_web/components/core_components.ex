defmodule DragNStampWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DragNStampWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DragNStampWeb.Gettext, "errors", msg, opts)
    end
  end
