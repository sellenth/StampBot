  ...
  def mount(_params, _session, socket) do
    ...
    {:ok,
     assign(socket,
       ...
       filter_channel: "",
       sort_by: "newest",
       page_title: "YouTube Timestamp Feed | Latest AI-Generated Video Chapters",
       page_description: "Browse the latest YouTube video timestamps generated by our AI. Find chapter markers and key moments from videos across all channels, updated in real-time."
     )}
  end
