defmodule DragNStampWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: DragNStampWeb.Layouts]
  ...
  defp html_helpers do
    quote do
      ...
      import Phoenix.HTML
      # Core UI components
      import DragNStampWeb.CoreComponents
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: DragNStampWeb.Router,
        statics: DragNStampWeb.static_paths()
    end
  end
